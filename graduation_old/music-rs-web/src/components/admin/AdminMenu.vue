<template>
	...
	<el-container id="all-screen">
			...
			>
				<el-submenu index="1">
					...
					<el-menu-item-group>
						...
						<el-menu-item index="1-1" style="padding-left: 150px;">歌曲管理</el-menu-item>
					</el-menu-item-group>
				</el-submenu>
			</el-menu>
		</el-aside>
		...
		<el-container>
			...
			>
				<el-input
					style="margin-left:10px;margin-top:5px;width:400px;height:50px;position:absolute;right:500px;"
					placeholder="请输入歌曲名"
					v-model="inputSearch"
			...
			<el-main>
				...
				<el-pagination
					...
					style="padding-top:30px;padding-left: 300px;"
